...
public class GuessinGameJava implements ActionListener, KeyListener {
	...
	GuessinGameJava(){
		...
		UIManager.put("OptionPane.background",new Color(4,20,27));
		UIManager.put("Panel.background", new Color(4,20,27));
		...
		textLabel3.setForeground(new Color(200,4,128));
		...
		guessTextField.setBackground(new Color(223,223,223));
		...
		ImageIcon icon=new ImageIcon("guess.png");
